        ...
        <nav className='sticky top-0 bg-black w-full p-4 z-50 shadow-md'>
            <div className="container mx-auto flex items-center justify-between">
                ...
                <div className='hidden md:flex items-center gap-8'>
                    ...
                    <a href="/request" className="bg-white text-black px-6 py-2 rounded-full text-sm font-semibold hover:bg-gray-100 transition-colors">
                        Try Free
                    </a>
                </div>
            ...
            {mobileMenuOpen && (
                <div className="md:hidden absolute top-full left-0 w-full bg-black py-4 px-6 flex flex-col gap-4 shadow-lg">
                    ...
                    <a href="/request" className="bg-white text-black px-6 py-3 rounded-full text-sm font-semibold hover:bg-gray-100 transition-colors text-center mt-2">
                        Try Free
                    </a>
                </div>
            )}
